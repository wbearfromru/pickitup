...
function putMarker(location){
	var marker = new google.maps.Marker({
		position: location,
		icon: 'https://mts.googleapis.com/vt/icon/name=icons/spotlight/spotlight-waypoint-blue.png',	
    });
    marker.setMap(map);
    return marker;
}
...
function addMarker(location, title, link) {
  ...
  google.maps.event.addListener(marker, 'click', function() {
	  	setDefaultIcons();
	    marker.setIcon('https://mts.googleapis.com/vt/icon/name=icons/spotlight/spotlight-poi.png');
  });
  return marker;
}
...
function setDefaultIcons(){
	for (var i = 0; i < markers.length; i++) {
		markers[i].setIcon('https://mts.googleapis.com/vt/icon/name=icons/spotlight/spotlight-waypoint-blue.png');
	};
}
